...
def Figure(mean,std,legend,filename):
    ...
    #设置误差标记参数
    plt.errorbar(x,mean[0],yerr=std[0],linewidth=1.5,color='#2A9D8C',marker='o',fmt='-',mec='black', ecolor='#2A9D8C',elinewidth=2, capsize=2, capthick=1, barsabove=True,label='20% Dropout I')
    plt.errorbar(x,mean[1],yerr=std[1],linewidth=1.5,color='#E9C46B',marker='o',fmt='-',mec='black', ecolor='#E9C46B',elinewidth=2, capsize=2, capthick=1, barsabove=True,label='40% Dropout I')
    plt.errorbar(x,mean[2],yerr=std[2],linewidth=1.5,color='#E66F51',marker='o',fmt='-',mec='black', ecolor='#E66F51',elinewidth=2, capsize=2, capthick=1, barsabove=True,label='60% Dropout I')
    ...
    plt.legend(loc='best',edgecolor='black',prop=font1,ncol=1)
...
def show():
    ...
    Figure(mean1,std1,legend1,'recovery_gradients_femnist')
