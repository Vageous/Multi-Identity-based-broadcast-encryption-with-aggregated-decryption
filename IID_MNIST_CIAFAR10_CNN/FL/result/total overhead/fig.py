...
def Figure(mean,std,legend,filename):
    ...
    plt.yticks(np.arange(0,30,5),size=18)
...
def show():
    filepath='./'
    legend1=['No-Droptype','30% Droptype I','30% Droptype II']
    legend2=['No-Droptype','30% Droptype I','30% Droptype II']
    filename1=['0.6droptype2.txt','0.6droptype1.txt','droptype0.txt']
    filename2=['0.6droptype2.txt','0.6droptype2.txt','droptype0.txt']
    # mean1,std1=read(filepath,filename1)
    # Figure(mean1,std1,legend1,'total_mnist')
    mean2,std2=read(filepath,filename2)
    Figure(mean2,std2,legend2,'total_femnist')
